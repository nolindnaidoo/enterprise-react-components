...
stories.add(
  'Standard',
  withInfo('A message displays information that explains nearby content.')(
    () => {
      ...
      const compactChange = boolean('Compact', false);
      const errorChange = boolean('Error', false);
      const floatingChange = boolean('Floating', false);
      const hiddenChange = boolean('Hidden', false);
      const infoChange = boolean('Info', false);
      const negativeChange = boolean('Negative', false);
      const positiveChange = boolean('Positive', false);
      const sizeOptions = {
        none: '',
        mini: 'Mini',
        tiny: 'Tiny',
      ...
      const visibleChange = boolean('Visible', false);
...
stories.add(
  ...
  withInfo('VideoPlayer is a web video player.')(() => {
    ...
    const defaultName = 'circle notched';
    const nameChange = select('Icon', nameOptions, defaultName);
    return (
      <Message icon>
        <Icon name={nameChange} loading={loading} />
        <MessageContent>
          <MessageHeader>Just a second</MessageHeader>
